...
If the same line mixes animals and footmen, the whole slot stays a normal AI. See ``docs/en/hunting-system.md`` §3.1.
...
describe that objective only. See ``docs/en/map-unit-index-selectors.md``; examples
...
``docs/en/campaign-secret-letter-alliance.md`` for the full northern arc (ch. 24–27).
...
+----------------------------+---------------------------+---------------------------+
| Mechanism                  | Config                    | Carries                   |
+============================+===========================+===========================+
| ``campaign_carryover``     | ``rules.txt`` unit fields | Level+XP, inventory       |
|                            |                           | (split; see modding.rst)  |
+----------------------------+---------------------------+---------------------------+
| ``campaign_flag`` /        | map triggers              | story booleans            |
| ``set_campaign_flag``      |                           |                           |
+----------------------------+---------------------------+---------------------------+
| ``add_inventory_item``     | map triggers              | specific items            |
+----------------------------+---------------------------+---------------------------+
...
The Legend of Raynor **northern arc** (ch. **24**–**27**): continuous storyline with shared ``traitor_guard`` objective and ``campaign_flag`` carryover. See ``docs/en/campaign-secret-letter-alliance.md``:
...
``N.coop.txt``). See ``docs/en/developer/coop-campaign.md`` and
``docs/en/player/campaign-and-co-op-improvements.md``.
...
chained goals). Guide: ``docs/en/progressive-campaign-objectives.md``.
