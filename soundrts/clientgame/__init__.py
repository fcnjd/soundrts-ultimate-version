...
GameInterface.cmd_rmg_trade_wood = game_audio.cmd_rmg_trade_wood
GameInterface.cmd_rmg_trade_food = game_audio.cmd_rmg_trade_food
GameInterface.cmd_rmg_trade_open_borders = game_audio.cmd_rmg_trade_open_borders
...
GameInterface.cmd_culture_status = game_resources.cmd_culture_status
GameInterface.cmd_diplomacy_status = game_resources.cmd_diplomacy_status
